...
int main()
{
	...
	contBancar contBancarMihai("Mihai", 20, 100, tranzactii, 2);
	contBancar contBancarCopie = contBancarMihai;

	cout << contBancarMihai(10) << endl;

	cout << contBancarMihai << contBancarCopie;
	cin >> contBancarMihai;
	cout << contBancarMihai;

	contBancarDeCredit credit("Bogdan", 33, tranzactii, 2, 10, "RO123BCR");
	contBancar cont = credit;
	contBancarDeCredit credit2("Remus", 22, tranzactii, 2, 10, "ASD123");
